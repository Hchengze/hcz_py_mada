...
- Full command-surface coverage remains low: `129 / 2114 = 6.10%`.
- Core `system/` + `plot/main` coverage is `116 / 301 = 38.54%`.
...
- Only 65 commands are registered as `pymada-*` console scripts.
