...
- Full command-surface coverage remains low: `124 / 2114 = 5.87%`.
- Core `system/` + `plot/main` coverage is `111 / 301 = 36.88%`.
...
- Only 60 commands are registered as `pymada-*` console scripts.
