...
9. **Forward modeling validation.** F0-1 defines model/acquisition geometry and
   F0-2 connects it to one acoustic2d shot wrapper; a later pass should add an
   accuracy-validation matrix or tiny geometry-driven workflow without adding a
   new solver or kernel.
