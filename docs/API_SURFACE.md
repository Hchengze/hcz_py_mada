...
The CLI inventory currently contains 157 user-facing modules. Every module is
...
in `pyproject.toml`. The current registered inventory is 54 scripts.
...
At the G2-3 baseline, conservative coverage remains:

- Full Madagascar/alias command surface: `118 / 2114 = 5.58%`.
- Core `system/` + `plot/main`: `105 / 301 = 34.88%`.
