...
I0-0/I0-1/I0-2/I0-3/I0-4; the mindmap is intentionally not regenerated during
these topic passes.
...
conjgrad, conv, convolve, corr, costaper, cp, csd, cut, dd, decimate, demean,
deriv, detrend,
diff, disfil, div, dottest,
envcorr, envelope, exp, fft, fillnan, filterbank, filtfilt, firfilter, firwin,
...
- **Operators and least squares:** use `MatrixOperator`, dot tests,
  ...
  they are not root/API exports or CLI features. CGLS and LSQR remain designed
  but unimplemented. Start with `linear_operator_tools_demo.py` for the stable
